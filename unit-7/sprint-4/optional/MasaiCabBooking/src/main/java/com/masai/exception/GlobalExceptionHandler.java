...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> UserException(UserException ee,WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> DriverException(DriverException ee,WebRequest req){
